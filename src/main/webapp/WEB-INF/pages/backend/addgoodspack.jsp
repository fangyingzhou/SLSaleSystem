	...
	<ul class="breadcrumb">
		...
		<li><a href="/backend/addgoodspack.html">添加商品套餐</a></li>
			...
			<legend>添加商品套餐</legend>
                 <form action="/backend/saveaddgoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return addGoodsPackFunc();">
					...
					<div class="control-group">
						...
						<div class="controls">
						<input type="text" id="a_num" name="num" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
						<span style="color:red;font-weight: bold;">*</span>
						</div>
					</div>
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" id="a_totalPrice" name="totalPrice" value="0" onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';else this.value2=this.value;"/>
						<span style="color:red;font-weight: bold;">*</span>
					  </div>
					</div>
